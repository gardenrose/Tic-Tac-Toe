namespace tic
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Click += new System.EventHandler(this.on_Click);
			// 
			// button3
			// 
			...
			this.button3.Click += new System.EventHandler(this.on_Click);
			// 
			// button4
			// 
			...
			this.button4.Click += new System.EventHandler(this.on_Click);
			// 
			// button5
			// 
			...
			this.button5.Location = new System.Drawing.Point(164, 235);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(146, 137);
			this.button5.TabIndex = 4;
			this.button5.UseVisualStyleBackColor = true;
			this.button5.Click += new System.EventHandler(this.on_Click);
			// 
			// button6
			// 
			...
			this.button6.Location = new System.Drawing.Point(316, 235);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(146, 137);
			this.button6.TabIndex = 5;
			this.button6.UseVisualStyleBackColor = true;
			this.button6.Click += new System.EventHandler(this.on_Click);
			// 
			// button7
			// 
			...
			this.button7.Click += new System.EventHandler(this.on_Click);
			// 
			// button8
			// 
			...
			this.button8.Location = new System.Drawing.Point(164, 378);
			this.button8.Name = "button8";
			this.button8.Size = new System.Drawing.Size(146, 137);
			this.button8.TabIndex = 7;
			this.button8.UseVisualStyleBackColor = true;
			this.button8.Click += new System.EventHandler(this.on_Click);
			// 
			// button9
			// 
			...
			this.button9.Location = new System.Drawing.Point(316, 378);
			this.button9.Name = "button9";
			this.button9.Size = new System.Drawing.Size(146, 137);
			this.button9.TabIndex = 8;
			this.button9.UseVisualStyleBackColor = true;
			this.button9.Click += new System.EventHandler(this.on_Click);
			// 
			// textBox1
			// 
			...
			this.buttonNewGame.Location = new System.Drawing.Point(238, 37);
			this.buttonNewGame.Name = "buttonNewGame";
			this.buttonNewGame.Size = new System.Drawing.Size(224, 52);
			this.buttonNewGame.TabIndex = 10;
			this.buttonNewGame.Text = "New game";
			this.buttonNewGame.UseVisualStyleBackColor = true;
			this.buttonNewGame.Click += new System.EventHandler(this.NewGameClick);
			// 
			// Form1
			// 
